========================================================================
    ACTIVE TEMPLATE LIBRARY : Sqlite Project Overview
========================================================================

AppWizard has created this Sqlite project for you to use as the starting point for
...
Sqlite.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (Sqlite.h)
        GUID definitions                                (Sqlite_i.c)
        A type library                                  (Sqlite.tlb)
        Marshaling code                                 (Sqlite_p.c and dlldata.c)

Sqlite.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in Sqlite.idl. It will be regenerated by MIDL during compilation.
...
Sqliteps.vcxproj
	...
	dlldata.c, Sqlite_i.c and Sqlite_p.c which are required
	to build the proxy/stub DLL.

Sqliteps.vcxproj.filters
