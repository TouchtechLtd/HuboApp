...
namespace Hubo.WinPhone
{
    public class FileAccessHelper
    {
        ...
        {
            //var storageFile = IsolatedStorageFile.GetUserStorForApplication();

            //if (!storageFile.FileExists(dbPath))
            //{
            //    using (var resourceStream = Application.GetResourceStream(new Uri ("hubo.db3", UriKind.Relative)).Stream)
            //    {
